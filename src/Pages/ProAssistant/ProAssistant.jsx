...
const ProAssistant = () => {   
    ...
    const [textEditorData, setTextEditorData] = useState("You can write some text here. For example try: (1) Working on Mental Health Assistant Application, (2) Working on Teacher Assistant Application or (3)Just writing some ramdon text here ");
    ...
    useEffect(() => {
        ...
        alanBtn({
            ...
            onCommand: (command, articles, number) => {
                ...
                } else if (command.command === 'write:texteditor1') {
                    setTextEditorData(command.messageWrite1);
                    setTempTextEditorData(command.messageWrite1);
                    setCopyTextEditorFlag(true);
                } else if (command.command === 'write:texteditor2') {
                    setTextEditorData(command.messageWrite2);
                    setTempTextEditorData(command.messageWrite2);
                    setCopyTextEditorFlag(true);
                } else if (command.command === 'write:texteditor3') {
                    setTextEditorData(command.messageWrite3);
                    setTempTextEditorData(command.messageWrite3);
                    setCopyTextEditorFlag(true);
